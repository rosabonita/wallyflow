...
db = MySQLdb.connect(user="wallyflow",
                     passwd="wallyflow",
                     port=3306,host="wallyflowdb.czadegulsxh8.us-east-1.rds.amazonaws.com",
                     db="wallyflow")
cursor = db.cursor()
...
def create_favorite_color_attribte(favorite_color):
    return {"favoriteColor": favorite_color}

def set_color_in_session(intent, session):
    #Sets the maxStillTime in the session and prepares the speech to reply to the user."""
    ...
    if 'Color' in intent['slots']:
        ...
        card_title, speech_output, reprompt_text, shoud_end_session))
